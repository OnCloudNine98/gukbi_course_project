  ...
  <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
   ...
   <div class="card align-middle" style="width:25rem; background-color:transparent; border-color:white;">
      <div class="card-title" style="margin-top:30px;">
        ...
        <div class="checkbox">
            <div style="color: #53eba6; margin-right: 20px; text-align:center;"><비밀번호 재설정결과></div>
      <div class="card-body">
        
        <center>
        
      <p>${message}</p>
      <button id="button" class="btn btn-outline-info " onclick="location.href='../login/Login.jsp'">로그인 화면 이동</button>
      </center>
      </div>
