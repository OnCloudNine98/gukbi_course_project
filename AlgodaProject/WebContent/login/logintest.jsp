...
<head>
  ...
  <script>
    ...
    //   // openWin = window.open("Idcheck.html?id=" + id, "childForm", "width=350px, height=280px");
    ...
    function Idcheck() {
      ...
      openWin = window.open("../login/Idcheck.do?id=" + id, "childForm", "width=570, height=350, resizable = no, scrollbars = no");
      openWin.document.getElementById("cInput").value = document.getElementById("id").value;
    }
  ...
  <div class="container mx-auto" style="margin: 0 auto;">
    <main>
      ...
      <div class="row justify-content-center">
        <form class="needs-validation" novalidate action="../Memberjoin.do" method="post" name="joinform" id="joinform">
          ...
          <div class="col-12">
            ...
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control" name="id" id="id" placeholder="아이디 입력" required onchange="">
              <button class="btn btn-secondary" type="button" name="idbtn" id="idbtn" onclick="Idcheck()">중복확인</button>
          ...
          <div class="col-12">
            ...
            <input type="text" class="form-control" name="hint_asw" id="hint_asw" maxlength="20" placeholder="--직접 입력--"
              required>
          ...
          <div class="text-center">
            <button class="w-10 btn btn-secondary btn-lg" type="submit"
              onclick="return validateform()">가입하기</button>&nbsp;&nbsp;&nbsp;&nbsp;
